...
export class YPwmInput extends YSensor
{
     ...
     *
     * @return {number} an integer corresponding to the input signal sampling rate, in kHz
     *
     ...
     *
     * @return {number} an integer corresponding to the number of edges detected per preiod
     *
...
export class YPwmInputProxy extends YSensorProxy
{
