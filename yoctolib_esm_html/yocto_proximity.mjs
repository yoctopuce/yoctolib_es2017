...
export class YProximity extends YSensor
{
     ...
     * as a binary input (on/off).
     *
     * @return {number} an integer corresponding to the hysteresis used to determine the logical state of
     * the proximity sensor, when considered
     *         as a binary input (on/off)
     *
     ...
     *
     * @return {number} an integer corresponding to the minimal detection duration before signalling a presence event
     *
     ...
     * considered as noise or bounce (false positive) and filtered out.
     *
     * @return {number} an integer corresponding to the minimal detection duration before signalling a removal event
     *
