/*********************************************************************
 *
 * $Id: yocto_messagebox.js 72410 2026-03-11 07:18:41Z mvuilleu $
 *
...
class YSms
{
     ...
     *
     * @return {Promise<boolean>} a boolean.
     */
     ...
     *
     * @return {Promise<string>} the timestamp as a text string.
     */
    async get_timestamp()
    {
        return this._stamp;
     ...
     *
     * @return {Promise<string>} a text string.
     */
    async get_sender()
    {
        return this._orig;
     ...
     *
     * @return {Promise<string>} a string with the content of the message.
     */
    async get_textData()
    {
        /** @type {Uint8Array} **/
     ...
     *
     * @return {Promise<number[]} a list of integers.
     */
     ...
     *
     * @param val {number[]} : a list of unicode characters provided as integers
     *
     * @return {Promise<number>} YAPI.SUCCESS when the call succeeds.
     */
...
async function yInternalEventCallback(YMessageBox_obj, str_value)
{
...
class YMessageBox extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of message storage slots currently in use
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the total number of message storage slots on the SIM card
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of SMS units sent so far
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of SMS units received so far
     *
     ...
     * attribute empty.
     *
     * @return {Promise<string>} a string corresponding to the phone number authorized to send remote
     * management commands
     *
     ...
     *
     * @param newval {string} : a string corresponding to the phone number authorized to send remote
     * management commands
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the SMS message box interface, for instance
     *         YHUBGSM1.messageBox.
     *
     ...
     *         national number, or in international format starting with a plus sign
     *
     * @return {Promise<YSms>} YAPI.SUCCESS when the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     */
     ...
     *
     * @return {Promise<YSms[]} an YSms object list.
     *
     ...
     *
     * @param callback {YMessageBox.SmsCallback | null} : the callback function to call, or a null pointer.
     ...
     *
     * @return {YMessageBox | null} a pointer to a YMessageBox object, corresponding to
...
class YMessageBoxProxy extends YFunctionProxy
{
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    registerSmsCallback(callback)
    {
        this.liveFunc.registerSmsCallback(callback);
        return YAPI_SUCCESS;
    }
