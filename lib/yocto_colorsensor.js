...
class YColorSensorProxy extends YFunctionProxy
{
    ...
    get_autoGain()
    {
        return this.liveFunc._autoGain;
    }
    ...
    set_autoGain(newval)
    {
        this.liveFunc.set_autoGain(newval);
        return this._yapi.SUCCESS;
    }
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    configureAutoGain(channel,minRaw,maxRaw,noSatur)
    {
        this.liveFunc.configureAutoGain(channel, minRaw, maxRaw, noSatur);
        return YAPI_SUCCESS;
    }
