/*********************************************************************
 *
 * $Id: yocto_colorledcluster.js 72910 2026-04-22 09:06:25Z mvuilleu $
 *
...
class YColorLedCluster extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of LEDs currently handled by the device
     *
     ...
     *
     * @return {Promise<number>} a value among YColorLedCluster.LEDTYPE_RGB, YColorLedCluster.LEDTYPE_RGBW
     ...
     * saveToFlash() method to save the setting permanently.
     *
     * @param newval {number} : a value among YColorLedCluster.LEDTYPE_RGB, YColorLedCluster.LEDTYPE_RGBW
     * and YColorLedCluster.LEDTYPE_WS2811 corresponding to the RGB LED type currently handled by the device
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximum number of LEDs that the device can handle
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximum number of LEDs that can perform
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximum number of sequences that the device can handle
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximum length of sequences
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the RGB LED cluster, for instance
     ...
     *
     * @param ledIndex {number} : index of the first LED which should be updated
     * @param rgbList {number[]} : a list of 24bit RGB codes, in the form 0xRRGGBB
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @param ledIndex {number} : index of the first LED which should be updated
     * @param rgbList {number[]} : a list of target 24bit RGB codes, in the form 0xRRGGBB
     * @param delay   : transition duration in ms
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @param ledIndex {number} : index of the first LED which should be updated
     * @param hslList {number[]} : a list of 24bit HSL codes, in the form 0xHHSSLL
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @param hslList {number[]} : a list of target 24bit HSL codes, in the form 0xHHSSLL
     * @param delay   : transition duration in ms
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @return {Promise<Uint8Array>} a binary buffer with RGB components of selected LEDs.
     *
     ...
     * @param count    : number of LEDs which should be returned
     *
     * @return {Promise<number[]} a list of 24bit color codes with RGB components of selected LEDs, as 0xRRGGBB.
     *
     ...
     * @param count    : number of LEDs which should be returned
     *
     * @return {Promise<number[]} a list of integers with sequence index
     *
     * On failure, throws an exception or returns an empty array.
     */
     ...
     *
     * @return {Promise<number[]} a list of 32 bit integer signatures
     *
     * On failure, throws an exception or returns an empty array.
     */
     ...
     *
     * @return {Promise<number[]} a list of integers, 0 for sequences turned off and 1 for sequences running
     *
     * On failure, throws an exception or returns an empty array.
     */
    ...
    {
        if (temp3 >= 170) {
            return parseInt((temp1 + 127) / 255, 10);
        }
        if (temp3 > 42) {
            if (temp3 <= 127) {
                return parseInt((temp2 + 127) / 255, 10);
            }
            temp3 = 170 - temp3;
        }
        return parseInt((temp1*255 + (temp2-temp1) * (6 * temp3) + 32512) / 65025, 10);
    }
     ...
     *
     * @return {YColorLedCluster | null} a pointer to a YColorLedCluster object, corresponding to
...
class YColorLedClusterProxy extends YFunctionProxy
{
    ...
    set_ledType(newval)
    {
        this.liveFunc.set_ledType(newval);
        return this._yapi.SUCCESS;
    }
    ...
    get_dynamicLedCount()
    {
        return this.liveFunc._dynamicLedCount;
    }
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    set_hslColorAtPowerOn(ledIndex,count,hslValue)
    {
        this.liveFunc.set_hslColorAtPowerOn(ledIndex, count, hslValue);
        return YAPI_SUCCESS;
    }
    ...
    shl_rgb(rgbValue)
    {
        this.liveFunc.shl_rgb(rgbValue);
        return YAPI_SUCCESS;
    }
    ...
    shr_rgb(rgbValue)
    {
        this.liveFunc.shr_rgb(rgbValue);
        return YAPI_SUCCESS;
    }
    ...
    shl_hsl(hslValue)
    {
        this.liveFunc.shl_hsl(hslValue);
        return YAPI_SUCCESS;
    }
    ...
    shr_hsl(hslValue)
    {
        this.liveFunc.shr_hsl(hslValue);
        return YAPI_SUCCESS;
    }
    ...
    {
        this.liveFunc.hsl2rgbInt(temp1, temp2, temp3);
        return YAPI_SUCCESS;
    }

    hsl2rgb(hslValue)
    {
        this.liveFunc.hsl2rgb(hslValue);
        return YAPI_SUCCESS;
    }
