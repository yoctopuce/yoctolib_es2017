/*********************************************************************
 *
 * $Id: yocto_colorledcluster.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YColorLedCluster extends YFunction
{
     ...
     *
     * @return {Promise<number>} either YColorLedCluster.LEDTYPE_RGB or YColorLedCluster.LEDTYPE_RGBW,
     ...
     * saveToFlash() method to save the setting permanently.
     *
     * @param newval {number} : either YColorLedCluster.LEDTYPE_RGB or YColorLedCluster.LEDTYPE_RGBW,
     * according to the RGB LED type currently handled by the device
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
