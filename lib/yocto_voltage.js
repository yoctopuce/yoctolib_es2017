...
class YVoltage extends YSensor
{
     ...
     * method of the module if the modification must be kept.
     *
     * @param newval {number} : a floating point number corresponding to the DC bias configured for zero
     * shift adjustment
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the DC bias configured for zero
     * shift adjustment
     *
