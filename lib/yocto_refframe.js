/*********************************************************************
 *
 *  $Id: yocto_refframe.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YRefFrame extends YFunction
{
     ...
     * heading and the reference bearing indicated here.
     *
     * @return {Promise<number>} a floating point number corresponding to the reference bearing used by the compass
     *
     ...
     *
     * @return {Promise<number>} a value among YRefFrame.FUSIONMODE_NDOF,
     ...
     * YRefFrame.FUSIONMODE_INCLIN_90DEG_3G6 and YRefFrame.FUSIONMODE_INCLIN_10DEG corresponding to the
     * sensor fusion mode
     *
     ...
     *
     * @param newval {number} : a value among YRefFrame.FUSIONMODE_NDOF,
     * YRefFrame.FUSIONMODE_NDOF_FMC_OFF, YRefFrame.FUSIONMODE_M4G, YRefFrame.FUSIONMODE_COMPASS,
     * YRefFrame.FUSIONMODE_IMU, YRefFrame.FUSIONMODE_INCLIN_90DEG_1G8,
     ...
     *
     * @param func {string} : a string that uniquely characterizes the reference frame, for instance
     *         Y3DMK002.refFrame.
     *
     ...
     *
     * @return {Promise<number>} a value among the YRefFrame.MOUNTPOSITION enumeration
     ...
     * pitch/roll tilt sensors.
     *
     * @return {Promise<number>} a value among the enumeration YRefFrame.MOUNTORIENTATION
     ...
     *
     * @param position {number} : a value among the YRefFrame.MOUNTPOSITION enumeration
     *         (YRefFrame.MOUNTPOSITION_BOTTOM,   YRefFrame.MOUNTPOSITION_TOP,
     *         YRefFrame.MOUNTPOSITION_FRONT,    YRefFrame.MOUNTPOSITION_RIGHT,
     *         YRefFrame.MOUNTPOSITION_REAR,     YRefFrame.MOUNTPOSITION_LEFT),
     *         corresponding to the installation in a box, on one of the six faces.
     * @param orientation {number} : a value among the enumeration YRefFrame.MOUNTORIENTATION
     *         (YRefFrame.MOUNTORIENTATION_TWELVE, YRefFrame.MOUNTORIENTATION_THREE,
     *         YRefFrame.MOUNTORIENTATION_SIX,     YRefFrame.MOUNTORIENTATION_NINE)
     *         corresponding to the orientation of the "X" arrow on the device,
     *         as on a clock dial seen from an observer in the center of the box.
     ...
     *
     * @return {Promise<number>} an integer representing the calibration state of Yocto-3D-V2:
     ...
     *
     * @return {Promise<number>} an integer between 0 and 3 (3 when the measure is reliable)
     *
     * On failure, throws an exception or returns a negative error code.
     * For the Yocto-3D (V1), this function always return -3 (unsupported function).
     */
     ...
     *
     * @return {Promise<string>} a character string.
     */
     ...
     *
     * @return {Promise<number>} an integer between 0 (not started) and 100 (stage completed).
     */
     ...
     * initiated with method start3DCalibration.
     *
     * @return {Promise<number>} an integer, growing each time a calibration stage is completed.
     */
     ...
     *
     * @return {YRefFrame | null} a pointer to a YRefFrame object, corresponding to
