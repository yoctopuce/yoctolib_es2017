/*********************************************************************
 *
 *  $Id: yocto_refframe.js 37827 2019-10-25 13:07:48Z mvuilleu $
 *
...
class YRefFrame extends YFunction
{
     ...
     *
     * @return {number} a value among YRefFrame.FUSIONMODE_NDOF, YRefFrame.FUSIONMODE_NDOF_FMC_OFF,
     ...
     * YRefFrame.FUSIONMODE_NDOF_FMC_OFF, YRefFrame.FUSIONMODE_M4G, YRefFrame.FUSIONMODE_COMPASS and
     * YRefFrame.FUSIONMODE_IMU
     *
     * @return {number} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
