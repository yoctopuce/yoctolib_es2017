...
{
    await YInputChain_inputChain._internalEventHandler(str_value);
}
...
class YInputChain extends YFunction
{
     ...
     * input chain.
     *
     * @param callback {YInputChain.EventCallback | null} : the callback function to call, or a null pointer.
