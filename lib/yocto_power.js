/*********************************************************************
 *
 *  $Id: yocto_power.js 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YPower extends YSensor
{
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the power factor (PF), i.e
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the Displacement Power factor (DPF), i.e
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the energy counter, maintained
     * by the wattmeter by integrating the
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the energy counter, maintained
     * by the wattmeter by integrating the power consumption over time,
     ...
     *
     * @return {Promise<number>} an integer corresponding to the elapsed time since last energy counter
     * reset, in seconds
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the electrical power sensor, for instance
     *         YWATTMK1.power.
     *
     ...
     *
     * @return {YPower | null} a pointer to a YPower object, corresponding to
...
class YPowerProxy extends YSensorProxy
{
    ...
    get_powerFactor()
    {
        return this.liveFunc._powerFactor;
    }
    ...
    {
        return this.liveFunc._deliveredEnergyMeter;
    }
    ...
    {
        return this.liveFunc._receivedEnergyMeter;
    }
