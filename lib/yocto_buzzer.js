/*********************************************************************
 *
 *  $Id: yocto_buzzer.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YBuzzer extends YFunction
{
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the  frequency of the signal
     * sent to the buzzer/speaker
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the volume of the signal sent to the buzzer/speaker
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current length of the playing sequence
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximum length of the playing sequence
     *
     ...
     * programmed.
     *
     * @return {Promise<number>} an integer corresponding to the playing sequence signature
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the buzzer, for instance
     *         YBUZZER2.buzzer.
     *
     ...
     * @param duration {number} : pulse duration in milliseconds
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     * @param duration {number} : change duration in milliseconds
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @return {YBuzzer | null} a pointer to a YBuzzer object, corresponding to
