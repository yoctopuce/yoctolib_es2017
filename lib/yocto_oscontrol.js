/*********************************************************************
 *
 *  $Id: yocto_oscontrol.js 63507 2024-11-28 10:44:36Z seb $
 *
...
class YOsControl extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the remaining number of seconds before the OS
     ...
     *
     * @param func {string} : a string that uniquely characterizes the OS control, for instance
     *         MyDevice.osControl.
     *
     ...
     *
     * @param secBeforeReboot {number} : number of seconds before reboot
     *
     * @return {Promise<number>} YAPI.SUCCESS when the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @return {YOsControl | null} a pointer to a YOsControl object, corresponding to
