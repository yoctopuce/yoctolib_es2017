/*********************************************************************
 *
 *  $Id: yocto_motor.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YMotor extends YFunction
{
     ...
     *
     * @return {Promise<number>} a value among YMotor.MOTORSTATUS_IDLE, YMotor.MOTORSTATUS_BRAKE,
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the power sent to the motor, as
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the braking force applied to the
     ...
     * occur when drawing current from an "empty" battery.
     *
     * @return {Promise<number>} a floating point number corresponding to the threshold voltage under
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current threshold (in mA) above which the
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the PWM frequency used to control the motor
     *
     ...
     * it start up.
     *
     * @return {Promise<number>} an integer corresponding to the duration (in ms) during which the motor
     ...
     *
     * @return {Promise<number>} an integer corresponding to the delay in milliseconds allowed for the
     ...
     *
     * @param func {string} : a string that uniquely characterizes the motor, for instance
     *         MOTORCTL.motor.
     *
     ...
     *
     * @return {YMotor | null} a pointer to a YMotor object, corresponding to
