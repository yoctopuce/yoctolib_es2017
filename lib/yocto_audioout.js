/*********************************************************************
 *
 *  $Id: yocto_audioout.js 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YAudioOut extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to audio output volume, in per cents
     *
     ...
     *
     * @return {Promise<number>} either YAudioOut.MUTE_FALSE or YAudioOut.MUTE_TRUE, according to the
     ...
     *
     * @return {Promise<string>} a string corresponding to the supported volume range
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the detected output current level
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of seconds elapsed without detecting a signal
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the audio output, for instance
     *         MyDevice.audioOut1.
     *
     ...
     *
     * @return {YAudioOut | null} a pointer to a YAudioOut object, corresponding to
