/*********************************************************************
 *
 *  $Id: yocto_multicellweighscale.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YMultiCellWeighScale extends YSensor
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of load cells in use
     *
     ...
     *
     * @return {Promise<number>} either YMultiCellWeighScale.EXTERNALSENSE_FALSE or
     ...
     *
     * @return {Promise<number>} a value among YMultiCellWeighScale.EXCITATION_OFF,
     ...
     * temperature. The standard rate is 0.2 per mille, and the maximal rate is 65 per mille.
     *
     * @return {Promise<number>} a floating point number corresponding to the averaged temperature update
     * rate, in per mille
     *
     ...
     * change compensation. The standard rate is 0.6 per mille, and the maximal rate is 65 per mille.
     *
     * @return {Promise<number>} a floating point number corresponding to the temperature change update
     * rate, in per mille
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the current averaged
     * temperature, used for thermal compensation
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the current temperature
     * variation, used for thermal compensation
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the current current thermal
     * compensation value
     *
     ...
     * zero compensation will be updated.
     *
     * @return {Promise<number>} a floating point number corresponding to the zero tracking threshold value
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the multi-cell weighing scale sensor, for instance
     ...
     *
     * @return {YMultiCellWeighScale | null} a pointer to a YMultiCellWeighScale object, corresponding to
