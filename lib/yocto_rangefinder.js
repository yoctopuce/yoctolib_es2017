/*********************************************************************
 *
 * $Id: yocto_rangefinder.js 50689 2022-08-17 14:37:15Z mvuilleu $
 *
...
class YRangeFinder extends YSensor
{
     ...
     *
     * @return {Promise<number>} a value among YRangeFinder.RANGEFINDERMODE_DEFAULT,
     ...
     *
     * @return {Promise<number>} an integer corresponding to the time frame used to measure the distance
     ...
     *
     * @return {Promise<number>} an integer corresponding to a measure quality estimate, based on measured dispersion
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the current sensor temperature,
     ...
     *
     * @param func {string} : a string that uniquely characterizes the range finder, for instance
     ...
     * is required.
     *
     * @return {Promise<number>} a temperature, as a floating point number.
     ...
     *
     * @return {YRangeFinder | null} a pointer to a YRangeFinder object, corresponding to
