/*********************************************************************
 *
 *  $Id: yocto_segmenteddisplay.js 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YSegmentedDisplay extends YFunction
{
     ...
     *
     * @return {Promise<string>} a string corresponding to the text currently displayed on the screen
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the segmented display, for instance
     ...
     *
     * @return {YSegmentedDisplay | null} a pointer to a YSegmentedDisplay object, corresponding to
