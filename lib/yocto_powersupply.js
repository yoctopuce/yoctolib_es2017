/*********************************************************************
 *
 *  $Id: yocto_powersupply.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YPowerSupply extends YFunction
{
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the voltage set point, in V
     *
     ...
     *
     * @return {Promise<number>} either YPowerSupply.VOLTAGESENSE_INT or YPowerSupply.VOLTAGESENSE_EXT,
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the internal voltage, in V
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the LDO temperature, in Celsius
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the selected voltage set point
     * at device startup, in V
     *
