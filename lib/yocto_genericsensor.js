/*********************************************************************
 *
 *  $Id: yocto_genericsensor.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YGenericSensor extends YSensor
{
     ...
     * electrical signal measured by the sensor
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to the measuring unit of the electrical signal
     * used by the sensor
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to the input signal range used by the sensor
     *
     ...
     *
     * @param newval {string} : a string corresponding to the input signal range used by the sensor
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @return {Promise<string>} a string corresponding to the physical value range measured by the sensor
     *
     ...
     * method of the module if the modification must be kept.
     *
     * @param newval {string} : a string corresponding to the output value range, corresponding to the
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the electric signal bias for
     ...
     *
     * @return {Promise<number>} a value among YGenericSensor.SIGNALSAMPLING_HIGH_RATE,
     ...
     *
     * @return {Promise<number>} either YGenericSensor.ENABLED_FALSE or YGenericSensor.ENABLED_TRUE,
     ...
     * method of the module if the modification must be kept.
     *
     * @param newval {number} : either YGenericSensor.ENABLED_FALSE or YGenericSensor.ENABLED_TRUE,
     * according to the activation state of this input
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the generic sensor, for instance
     ...
     *
     * @return {YGenericSensor | null} a pointer to a YGenericSensor object, corresponding to
