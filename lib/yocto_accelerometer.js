/*********************************************************************
 *
 *  $Id: yocto_accelerometer.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YAccelerometer extends YSensor
{
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the X component of the
     * acceleration, as a floating point number
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the Y component of the
     * acceleration, as a floating point number
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the Z component of the
     * acceleration, as a floating point number
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the accelerometer, for instance
     ...
     *
     * @return {YAccelerometer | null} a pointer to a YAccelerometer object, corresponding to
