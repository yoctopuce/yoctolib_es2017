...
class YAirQuality extends YSensor
{
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the current air quality index,
     * according to UBA (from 1 to 5)
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the relative air quality index,
     * according to ScioSense (from 0 to 500)
     *
     ...
     *
     * @return {Promise<number>} either YAirQuality.AQIMODE_RELATIVE or YAirQuality.AQIMODE_UBA, according
     * to the type of index reported by the get_currentValue function and callbacks (UBA index or relative index)
     *
     ...
     *
     * @param newval {number} : either YAirQuality.AQIMODE_RELATIVE or YAirQuality.AQIMODE_UBA, according
     * to the the type of index reported by the get_currentValue function and callbacks (UBA index or relative index)
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the air quality sensor, for instance
     *         MyDevice.airQuality.
     *
     ...
     *
     * @return {YAirQuality | null} a pointer to a YAirQuality object, corresponding to
