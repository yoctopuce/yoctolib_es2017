/*********************************************************************
 *
 *  $Id: yocto_carbondioxide.js 44175 2021-03-11 11:27:12Z mvuilleu $
 *
...
class YCarbonDioxide extends YSensor
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the Automatic Baseline Calibration period, in hours
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the CO2 sensor, for instance
     ...
     * minutes.
     *
     * @param refVal {number} : reference CO2 density for the calibration
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @return {YCarbonDioxide | null} a pointer to a YCarbonDioxide object, corresponding to
...
class YCarbonDioxideProxy extends YSensorProxy
{
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    triggerForcedCalibration(refVal)
    {
        this.liveFunc.triggerForcedCalibration(refVal);
        return YAPI_SUCCESS;
    }
