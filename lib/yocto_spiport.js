/*********************************************************************
 *
 * $Id: yocto_spiport.js 27726 2017-06-02 13:18:52Z mvuilleu $
 *
...
class YSpiPort extends YFunction
{
    constructor(obj_yapi, str_func)
    {
        ...
        /** @member {number} **/
        this._shitftSampling             = YSpiPort.SHITFTSAMPLING_INVALID;
        /** @member {number} **/
        this._rxptr                      = 0;
        /** @member {Uint8Array} **/
    ...
    async get_syncProxy()
    {
        ...
        let res = new YSpiPortProxy(this);
     ...
     *
     * @return {number} either YSpiPort.SHITFTSAMPLING_OFF or YSpiPort.SHITFTSAMPLING_ON, according to
     ...
     *
     * @param newval {number} : either YSpiPort.SHITFTSAMPLING_OFF or YSpiPort.SHITFTSAMPLING_ON,
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    async set_shitftSampling(newval)
    {
        /** @type {string} **/
        let rest_val;
        rest_val = String(newval);
        return await this._setAttr('shitftSampling',rest_val);
    }
...
class YSpiPortProxy extends YFunctionProxy
{
    ...
    get_shitftSampling()
    {
        return this.liveFunc._shitftSampling;
    }
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    set_shitftSampling(newval)
    {
        this.liveFunc.set_shitftSampling(newval);
        return this._yapi.SUCCESS;
    }
