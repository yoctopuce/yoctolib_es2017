/*********************************************************************
 *
 * $Id: yocto_spiport.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YSpiPort extends YFunction
{
     ...
     *
     * @return {Promise<number>} a value among YSpiPort.VOLTAGELEVEL_OFF, YSpiPort.VOLTAGELEVEL_TTL3V,
     ...
     *
     * @return {Promise<string>} a string corresponding to the SPI port communication parameters, as a string such as
     *         "125000,0,msb"
     *
     ...
     *
     * @return {Promise<number>} either YSpiPort.SSPOLARITY_ACTIVE_LOW or YSpiPort.SSPOLARITY_ACTIVE_HIGH,
     ...
     *
     * @return {Promise<number>} either YSpiPort.SHIFTSAMPLING_OFF or YSpiPort.SHIFTSAMPLING_ON, according
     * to true when the SDI line phase is shifted with regards to the SDO line
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the SPI port, for instance
     *         YSPIMK01.spiPort.
     *
     ...
     *         in the receive buffer.
     *
     * @return {Promise<YSpiSnoopingRecord[]} an array of YSpiSnoopingRecord objects containing the
     ...
     *
     * @return {YSpiPort | null} a pointer to a YSpiPort object, corresponding to
