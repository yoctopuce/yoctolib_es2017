/*********************************************************************
 *
 *  $Id: yocto_led.js 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YLed extends YFunction
{
     ...
     *
     * @return {Promise<number>} either YLed.POWER_OFF or YLed.POWER_ON, according to the current LED state
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current LED intensity (in per cent)
     *
     ...
     *
     * @return {Promise<number>} a value among YLed.BLINKING_STILL, YLed.BLINKING_RELAX,
     ...
     *
     * @param func {string} : a string that uniquely characterizes the monochrome LED, for instance
     *         YBUZZER2.led1.
     *
     ...
     *
     * @return {YLed | null} a pointer to a YLed object, corresponding to
