/*********************************************************************
 *
 *  $Id: yocto_digitalio.js 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YDigitalIO extends YFunction
{
     ...
     * and so on...
     *
     * @return {Promise<number>} an integer corresponding to the digital IO port state as an integer with each bit
     *         representing a channel
     *
     ...
     *
     * @param newval {number} : an integer corresponding to the state of all digital IO port's channels at
     * once: the parameter
     *         is an integer where each bit represents a channel, with bit 0 matching channel #0
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the I/O direction of all channels of the port
     ...
     *
     * @param newval {number} : an integer corresponding to the I/O direction of all channels of the port
     * (bitmap): 0 makes a bit an input, 1 makes it an output
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the electrical interface for each bit of the port
     *
     ...
     * intuitive way; for each bit set to 1, the I/O works in reverse mode.
     *
     * @return {Promise<number>} an integer corresponding to the polarity of all the bits of the port
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the port state diagnostics (Yocto-IO and
     * Yocto-MaxiIO-V2 only)
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of bits (i.e
     *
     ...
     *
     * @return {Promise<number>} a value among YDigitalIO.OUTPUTVOLTAGE_USB_5V,
     ...
     *
     * @param func {string} : a string that uniquely characterizes the digital IO port, for instance
     *         YMINIIO0.digitalIO.
     *
     ...
     * @param bitno {number} : the bit number; lowest bit has index 0
     *
     * @return {Promise<number>} the bit state (0 or 1)
     *
     * On failure, throws an exception or returns a negative error code.
     */
     ...
     * @param bitno {number} : the bit number; lowest bit has index 0
     *
     * @return {Promise<number>}   0 means the a bit is a regular input/output, 1 means the bit is an open-drain
     ...
     *
     * @return {YDigitalIO | null} a pointer to a YDigitalIO object, corresponding to
