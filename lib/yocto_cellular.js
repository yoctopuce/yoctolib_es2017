/*********************************************************************
 *
 * $Id: yocto_cellular.js 75541 2026-08-17 08:15:41Z seb $
 *
...
class YCellRecord
{
     ...
     *
     * @return {number} an integer corresponding to the Mobile Country Code (MCC).
     */
     ...
     *
     * @return {number} an integer corresponding to the Mobile Network Code (MNC).
     */
     ...
     *
     * @return {number} an integer corresponding to the Location Area Code (LAC).
     */
     ...
     *
     * @return {number} an integer corresponding to the Cell Id.
     */
    get_cellId()
    {
        return this._cid;
     ...
     *
     * @return {number} an integer corresponding to the signal strength.
     */
    get_signalStrength()
    {
        return this._dbm;
     ...
     *
     * @return {number} an integer corresponding to the Timing Advance (TA).
     */
    get_timingAdvance()
    {
        return this._tad;
...
class YCellular extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the link quality, expressed in percent
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to the name of the cell operator currently in use
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to the unique identifier of the cellular antenna
     * in use: MCC, MNC, LAC and Cell ID
     *
     ...
     *
     * @return {Promise<number>} a value among YCellular.CELLTYPE_GPRS, YCellular.CELLTYPE_EGPRS,
     ...
     *
     * @return {Promise<string>} a string corresponding to the International Mobile Subscriber Identity
     * (MSI) that uniquely identifies
     *         the SIM card
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to the latest status message from the wireless interface
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to an opaque string if a PIN code has been
     * configured in the device to access
     *         the SIM card, or an empty string if none has been configured or if the code provided
     *         was rejected by the SIM card
     *
     ...
     * cell operators.
     *
     * @return {Promise<string>} a string corresponding to the name of the only cell operator to use if
     ...
     *
     * @return {Promise<number>} either YCellular.AIRPLANEMODE_OFF or YCellular.AIRPLANEMODE_ON, according
     * to true if the airplane mode is active (radio turned off)
     *
     ...
     *
     * @return {Promise<number>} a value among YCellular.ENABLEDATA_HOMENETWORK,
     ...
     *
     * @return {Promise<string>} a string corresponding to the Access Point Name (APN) to be used, if needed
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to an opaque string if APN authentication
     ...
     *
     * @return {Promise<number>} an integer corresponding to the automated connectivity check interval, in seconds
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of bytes sent so far
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of bytes received so far
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the cellular interface, for instance
     *         YHUBGSM1.cellular.
     *
     ...
     *
     * @return {Promise<string>} a string with the result of the commands. Empty lines are
     ...
     *
     * @return {Promise<string[]} a list of string (cell operator names).
     */
     ...
     * serving cell.
     *
     * @return {Promise<YCellRecord[]} a list of YCellRecords.
     */
     ...
     *
     * @param mccmnc {string} : a string starting with a MCC code followed by a MNC code,
     *
     * @return {Promise<string>} a string containing the corresponding cell operator brand name.
     */
     ...
     *
     * @return {Promise<string[]} a list of string describing available radio communication profiles.
     */
     ...
     *
     * @return {YCellular | null} a pointer to a YCellular object, corresponding to
...
class YCellularProxy extends YFunctionProxy
{
    ...
    get_radioConfig()
    {
        return this.liveFunc._radioConfig;
    }
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    set_radioConfig(newval)
    {
        this.liveFunc.set_radioConfig(newval);
        return this._yapi.SUCCESS;
    }
    ...
    decodePLMN(mccmnc)
    {
        // not anymore relevant, maintained for backward-compatibility
        return mccmnc;
    }
...
YoctoLibExport('YCellRecord', YCellRecord);
YCellRecord.imm_Init();
