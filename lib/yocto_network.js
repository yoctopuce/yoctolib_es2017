...
class YNetwork extends YFunction
{
     ...
     *
     * @return {number} an integer corresponding to the TCP port used to serve the hub web UI
     *
     ...
     * YNetwork.CALLBACKENCODING_MQTT, YNetwork.CALLBACKENCODING_YOCTO_API_JZON and
     * YNetwork.CALLBACKENCODING_PRTG corresponding to the encoding standard to use for representing
     * notification values
     *
     * @return {number} YAPI.SUCCESS if the call succeeds.
     *
