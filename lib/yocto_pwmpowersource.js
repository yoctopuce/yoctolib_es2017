/*********************************************************************
 *
 *  $Id: yocto_pwmpowersource.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YPwmPowerSource extends YFunction
{
     ...
     *
     * @return {Promise<number>} a value among YPwmPowerSource.POWERMODE_USB_5V,
     * YPwmPowerSource.POWERMODE_USB_3V, YPwmPowerSource.POWERMODE_EXT_V and
     * YPwmPowerSource.POWERMODE_OPNDRN corresponding to the selected power source for the PWM on the same device
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the PWM generator power source, for instance
     ...
     *
     * @return {YPwmPowerSource | null} a pointer to a YPwmPowerSource object, corresponding to
