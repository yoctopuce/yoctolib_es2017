/*********************************************************************
 *
 *  $Id: yocto_anbutton.js 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YAnButton extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current calibrated input value (between 0
     * and 1000, included)
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current measured input value as-is
     ...
     *
     * @return {Promise<number>} either YAnButton.ANALOGCALIBRATION_OFF or YAnButton.ANALOGCALIBRATION_ON
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximal value measured during the
     * calibration (between 0 and 4095, included)
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the minimal value measured during the
     * calibration (between 0 and 4095, included)
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the sensibility for the input (between 1 and
     ...
     *
     * @return {Promise<number>} either YAnButton.ISPRESSED_FALSE or YAnButton.ISPRESSED_TRUE, according
     * to true if the input (considered as binary) is active (closed contact), and false otherwise
     *
     ...
     * the module power on and the last time
     *         the input button was pressed (the input contact transitioned from open to closed)
     *
     ...
     *
     * @return {Promise<number>} a value among YAnButton.INPUTTYPE_ANALOG_FAST,
     * YAnButton.INPUTTYPE_DIGITAL4, YAnButton.INPUTTYPE_ANALOG_SMOOTH and
     * YAnButton.INPUTTYPE_DIGITAL_FAST corresponding to the decoding method applied to the input (analog
     ...
     *
     * @param func {string} : a string that uniquely characterizes the analog input, for instance
     *         YBUZZER2.anButton1.
     *
     ...
     *
     * @return {YAnButton | null} a pointer to a YAnButton object, corresponding to
...
class YAnButtonProxy extends YFunctionProxy
{
    ...
    get_inputType()
    {
        return this.liveFunc._inputType;
    }
    ...
    {
        this.liveFunc.set_inputType(newval);
        return this._yapi.SUCCESS;
    }
