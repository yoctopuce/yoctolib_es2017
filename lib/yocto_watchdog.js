...
class YWatchdog extends YFunction
{
     ...
     *
     * @return {number} an integer corresponding to the maximum time (ms) allowed for $THEFUNCTIONS$ to stay in state
     ...
     *
     * @param newval {number} : an integer corresponding to the maximum time (ms) allowed for
