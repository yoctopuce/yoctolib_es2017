/*********************************************************************
 *
 *  $Id: yocto_watchdog.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YWatchdog extends YFunction
{
     ...
     *
     * @return {Promise<number>} either YWatchdog.STATE_A or YWatchdog.STATE_B, according to the state of
     ...
     *
     * @return {Promise<number>} a value among YWatchdog.STATEATPOWERON_UNCHANGED,
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximum time (ms) allowed for the
     * watchdog to stay in state
     ...
     *
     * @param newval {number} : an integer corresponding to the maximum time (ms) allowed for the watchdog
     * to stay in state A
     ...
     *
     * @return {Promise<number>} either YWatchdog.OUTPUT_OFF or YWatchdog.OUTPUT_ON, according to the
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of milliseconds remaining before
     * the watchdog is returned to idle position
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of milliseconds remaining before a
     * pulse (delayedPulse() call)
     *         When there is no scheduled pulse, returns zero
     *
     ...
     *
     * @return {Promise<number>} either YWatchdog.AUTOSTART_OFF or YWatchdog.AUTOSTART_ON, according to
     ...
     *
     * @return {Promise<number>} either YWatchdog.RUNNING_OFF or YWatchdog.RUNNING_ON, according to the
     ...
     *
     * @return {Promise<number>} an integer corresponding to  the waiting duration before a reset is
     ...
     *
     * @return {Promise<number>} an integer corresponding to the duration of resets caused by the
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of seconds spent since the last
     * output power-up event
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the watchdog, for instance
     *         WDOGDC01.watchdog1.
     *
     ...
     *
     * @return {YWatchdog | null} a pointer to a YWatchdog object, corresponding to
...
class YWatchdogProxy extends YFunctionProxy
{
    ...
    get_lastTrigger()
    {
        return this.liveFunc._lastTrigger;
    }
