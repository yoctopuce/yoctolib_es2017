/*********************************************************************
 *
 *  $Id: yocto_i2cport.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YI2cSnoopingRecord
{
     ...
     *
     * @return {Promise<number>} the elapsed time, in ms, since the beginning of the preceding message.
     */
    async get_time()
    {
        return this._tim;
     ...
     *
     * @return {Promise<number>} the message direction (RX=0, TX=1).
     */
    async get_direction()
    {
        return this._dir;
     ...
     *
     * @return {Promise<string>} the message content.
     */
    async get_message()
    {
        return this._msg;
...
class YI2cPort extends YFunction
{
     ...
     *
     * @return {Promise<string>} a string corresponding to the latest message fully received (for Line and
     * Frame protocols)
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to the type of protocol used to send I2C messages, as a string
     *
     ...
     * modification must be kept.
     *
     * @param newval {string} : a string corresponding to the type of protocol used to send I2C messages
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @return {Promise<number>} a value among YI2cPort.I2CVOLTAGELEVEL_OFF, YI2cPort.I2CVOLTAGELEVEL_3V3
     ...
     * modification must be kept.
     *
     * @param newval {number} : a value among YI2cPort.I2CVOLTAGELEVEL_OFF, YI2cPort.I2CVOLTAGELEVEL_3V3
     * and YI2cPort.I2CVOLTAGELEVEL_1V8 corresponding to the voltage level used on the I2C bus
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to the I2C port communication parameters, as a string such as
     ...
     * modification must be kept.
     *
     * @param newval {string} : a string corresponding to the I2C port communication parameters, with a string such as
     *         "400kbps,2000ms"
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the I2C port, for instance
     *         YI2CMK01.i2cPort.
     *
     ...
     * @param buff {Uint8Array} : the binary buffer to be sent
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @param slaveAddr {number} : the 7-bit address of the slave device (without the direction bit)
     * @param values {number[]} : a list of data bytes to be sent
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @return {Promise<Uint8Array>} a list of bytes with the data received from slave device.
     *
     ...
     * @param rcvCount {number} : the number of bytes to receive once the data bytes are sent
     *
     * @return {Promise<number[]} a list of bytes with the data received from slave device.
     *
     * On failure, throws an exception or returns an empty array.
     */
     ...
     * receive stream.
     *
     * @param codes {string} : the code stream to send
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *         in the receive buffer.
     *
     * @return {Promise<YI2cSnoopingRecord[]} an array of YI2cSnoopingRecord objects containing the
     ...
     *
     * @return {YI2cPort | null} a pointer to a YI2cPort object, corresponding to
...
class YI2cPortProxy extends YFunctionProxy
{
    ...
    get_i2cVoltageLevel()
    {
        return this.liveFunc._i2cVoltageLevel;
    }
    ...
    {
        this.liveFunc.set_i2cVoltageLevel(newval);
        return this._yapi.SUCCESS;
    }
