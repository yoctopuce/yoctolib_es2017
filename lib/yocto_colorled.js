/*********************************************************************
 *
 *  $Id: yocto_colorled.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YColorLed extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current RGB color of the LED
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current HSL color of the LED
     *
     ...
     *
     * @param newval {number} : an integer corresponding to the current color of the LED, using a specific HSL color
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
     ...
     *
     * @return {Promise<number>} an integer corresponding to the configured color to be displayed when the
     * module is turned on
     *
     ...
     *
     * @param newval {number} : an integer corresponding to the color that the LED displays by default
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current length of the blinking sequence
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximum length of the blinking sequence
     *
     ...
     * programmed.
     *
     * @return {Promise<number>} an integer corresponding to the blinking sequence signature
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the RGB LED, for instance
     *         YRGBLED2.colorLed1.
     *
     ...
     *
     * @param HSLcolor {number} : desired HSL color when the transition is completed
     ...
     *
     * @return {YColorLed | null} a pointer to a YColorLed object, corresponding to
