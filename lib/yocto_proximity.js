/*********************************************************************
 *
 * $Id: yocto_proximity.js 31431 2018-08-07 12:40:01Z seb $
 *
...
class YProximity extends YSensor
{
     ...
     *
     * @return {number} an integer corresponding to the minimal detection duration before signaling a presence event
     *
     ...
     * considered as noise or bounce (false positive) and filtered out.
     *
     * @return {number} an integer corresponding to the minimal detection duration before signaling a removal event
     *
