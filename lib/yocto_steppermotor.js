/*********************************************************************
 *
 *  $Id: yocto_steppermotor.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YStepperMotor extends YFunction
{
     ...
     *
     * @return {Promise<number>} a value among YStepperMotor.MOTORSTATE_ABSENT,
     * YStepperMotor.MOTORSTATE_ALERT, YStepperMotor.MOTORSTATE_HI_Z, YStepperMotor.MOTORSTATE_STOP,
     * YStepperMotor.MOTORSTATE_RUN and YStepperMotor.MOTORSTATE_BATCH corresponding to the motor working state
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the stepper motor controller diagnostics, as a bitmap
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the current logical motor
     * position, measured in steps
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to current motor speed, measured in
     * steps per second
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the motor speed immediately
     * reachable from stop state, measured in steps per second
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the maximal motor acceleration,
     * measured in steps per second^2
     *
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the maximal motor speed,
     ...
     *
     * @return {Promise<number>} a value among YStepperMotor.STEPPING_MICROSTEP16,
     ...
     *
     * @return {Promise<number>} an integer corresponding to the overcurrent alert and emergency stop
     ...
     *
     * @return {Promise<number>} an integer corresponding to the torque regulation current when the motor
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current value of the signal generated on
     ...
     *
     * @param func {string} : a string that uniquely characterizes the stepper motor, for instance
     ...
     *
     * @param relPos {number} : relative position, measured in steps from the current position.
     * @param maxSpeed {number} : limit speed, in steps per second.
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *         On failure, throws an exception or returns a negative error code.
     */
     ...
     * use this function with great care as it may cause mechanical damages !
     *
     * @param dir {number} : Value +1 or -1, according to the desired direction of the move
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *         On failure, throws an exception or returns a negative error code.
     */
     ...
     *
     * @return {YStepperMotor | null} a pointer to a YStepperMotor object, corresponding to
...
class YStepperMotorProxy extends YFunctionProxy
{
     ...
     *         On failure, throws an exception or returns a negative error code.
     */
    moveRelSlow(relPos,maxSpeed)
    {
        this.liveFunc.moveRelSlow(relPos, maxSpeed);
        return YAPI_SUCCESS;
    }
    ...
    alertStepDir(dir)
    {
        this.liveFunc.alertStepDir(dir);
        return YAPI_SUCCESS;
    }
