/*********************************************************************
 *
 * $Id: yocto_api.js 37692 2019-10-14 14:58:03Z seb $
 *
...
class YConsolidatedDataSet
{
    constructor(double_startTime, double_endTime, obj_sensorList)
    {
        ...
        this._init(double_startTime, double_endTime, obj_sensorList);
    }
    ...
    async _init(startt,endt,sensorList)
    {
        this._start = startt;
        this._end = endt;
...
//--- (generated code: YAPIContext constructor)
    ...
    imm_GetAPIVersion()
    {
        return /* version number patched automatically */'1.10.37780';
    }
