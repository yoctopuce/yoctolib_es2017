/*********************************************************************
 *
 * $Id: yocto_api.js 38914 2019-12-20 19:14:33Z mvuilleu $
 *
...
class YConsolidatedDataSet
{
    ...
    static Init(sensorNames,startTime,endTime)
    {
        ...
        while (idx < nSensors) {
            ...
            s = await YSensor.FindSensor(sensorName);
            sensorList.push(s);
            idx = idx + 1;
        }
...
class YModule extends YFunction
{
    ...
    async set_allSettingsAndFiles(settings)
    {
        ...
        return await this.set_allSettings(this._yapi.imm_str2bin(json_api));
    }
...
//--- (generated code: YAPIContext constructor)
    ...
    imm_GetAPIVersion()
    {
        return /* version number patched automatically */'1.10.38914';
    }
