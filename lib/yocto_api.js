/*********************************************************************
 *
 * $Id: yocto_api.js 53259 2023-02-16 11:17:20Z seb $
 *
...
class YFunction
{
     ...
     *
     * @return {Promise<boolean>} true if the function is readOnly or not online.
     */
    async isReadOnly()
    {
     ...
     * store a context.
     *
     * @return {Promise<object|null>} the object stored previously by the caller.
     */
    async get_userData()
    {
     ...
     *
     * @param data {object|null} : any kind of object to be stored
     * @noreturn
     */
...
//--- (generated code: YAPIContext constructor)
    ...
    async updateDeviceList_process(hub, hubDev, whitePages, yellowPages)
    {
        ...
        for(let devkey in whitePages) {
            ...
            if (currdev && this._arrivalCallback != undefined && hub._firstArrivalCallback) {
