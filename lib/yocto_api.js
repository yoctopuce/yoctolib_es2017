/*********************************************************************
 *
 * $Id: yocto_api.js 27516 2017-05-17 21:15:21Z mvuilleu $
 *
...
class YFunction
{
    constructor(obj_yapi, str_func)
    {
        ...
        /** @member {string} **/
        this.FUNCTIONDESCRIPTOR_INVALID  = YAPI.INVALID_STRING;
        /** @member {string} **/
        this.HARDWAREID_INVALID          = YAPI.INVALID_STRING;
        /** @member {string} **/
        this.FUNCTIONID_INVALID          = YAPI.INVALID_STRING;
        /** @member {string} **/
        this.FRIENDLYNAME_INVALID        = YAPI.INVALID_STRING;
        /** @member {string} **/
    ...
    async get_syncProxy()
    {
        ...
        let res = new YFunctionProxy(this);
...
class YWebSocketHub extends YGenericHub
{
    ...
    {
        var tcpchan_busy;
        var timeout = this._yapi.GetTickCount() + 3000;
        do {
            tcpchan_busy = false;
            for (var tcpchan = 0; tcpchan < 4; tcpchan++) {
...
//--- (end of generated code: YFunction return codes)
    ...
    imm_GetAPIVersion()
    {
        return /* version number patched automatically */'1.10.27515';
    }
    ...
    async TestHub(url, mstimeout)
    {
        ...
        newhub = this.imm_registerHub_internal(urlInfo);
        let errmsg = new YErrorMsg();
        return await newhub.testHub(errmsg);
    }
