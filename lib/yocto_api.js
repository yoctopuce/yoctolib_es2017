/*********************************************************************
 *
 * $Id: yocto_api.js 35252 2019-04-30 16:34:16Z mvuilleu $
 *
    ...
    async _invokeValueCallback(value)
    {
        if (this._valueCallbackFunction != null) {
            try {
                ...
                YAPI.imm_log('Exception in valueCallback:', e);
            }
        } else {
        }
        return 0;
...
//--- (generated code: YAPIContext constructor)
    ...
    /**
     * Registers a global log callback function. This callback will be called each time that an abnormal
     *         event occurs in the library. Mostly useful to debug problems.
     *
     * @param logfun {function} : the callback function to call, or a null pointer to log to the console (default).
     *         The callback function should take a character string as argument, which is the message to log
     *         On failure, throws an exception or returns a negative error code.
     */
    ...
    imm_GetAPIVersion()
    {
        return /* version number patched automatically */'1.10.35259';
    }
