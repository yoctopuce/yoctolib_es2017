/*********************************************************************
 *
 *  $Id: yocto_relay.js 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YRelay extends YFunction
{
     ...
     *
     * @return {Promise<number>} either YRelay.STATE_A or YRelay.STATE_B, according to the state of the
     ...
     *
     * @return {Promise<number>} a value among YRelay.STATEATPOWERON_UNCHANGED, YRelay.STATEATPOWERON_A
     * and YRelay.STATEATPOWERON_B corresponding to the state of the relays at device startup (A for the idle position,
     *         B for the active position, UNCHANGED to leave the relay state as is)
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the maximum time (ms) allowed for the relay
     * to stay in state
     ...
     *
     * @param newval {number} : an integer corresponding to the maximum time (ms) allowed for the relay to
     * stay in state A
     ...
     *
     * @return {Promise<number>} either YRelay.OUTPUT_OFF or YRelay.OUTPUT_ON, according to the output
     ...
     * the relays is returned to idle position
     ...
     *
     * @param func {string} : a string that uniquely characterizes the relay, for instance
     *         YLTCHRL1.relay1.
     *
     ...
     *
     * @return {YRelay | null} a pointer to a YRelay object, corresponding to
