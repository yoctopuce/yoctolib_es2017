/*********************************************************************
 *
 *  $Id: yocto_altitude.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YAltitude extends YSensor
{
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the barometric pressure adjusted
     * to sea level used to compute
     *         the altitude (QNH)
     *
     ...
     *
     * @return {Promise<string>} a string corresponding to the technology used by the sesnor to compute
     *         altitude
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the altimeter, for instance
     *         YALTIMK2.altitude.
     *
     ...
     *
     * @return {YAltitude | null} a pointer to a YAltitude object, corresponding to
