...
class YQuadratureDecoder extends YSensor
{
     ...
     *
     * @return {Promise<number>} a floating point number corresponding to the increments frequency, in Hz
     *
     ...
     *
     * @return {Promise<number>} a value among YQuadratureDecoder.DECODING_OFF,
     * YQuadratureDecoder.DECODING_ON, YQuadratureDecoder.DECODING_DIV2 and
     * YQuadratureDecoder.DECODING_DIV4 corresponding to the current activation state of the quadrature decoder
     *
     ...
     *
     * @param newval {number} : a value among YQuadratureDecoder.DECODING_OFF,
     * YQuadratureDecoder.DECODING_ON, YQuadratureDecoder.DECODING_DIV2 and
