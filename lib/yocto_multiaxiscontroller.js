/*********************************************************************
 *
 *  $Id: yocto_multiaxiscontroller.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YMultiAxisController extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of synchronized controllers
     *
     ...
     *
     * @return {Promise<number>} a value among YMultiAxisController.GLOBALSTATE_ABSENT,
     ...
     *
     * @param func {string} : a string that uniquely characterizes the multi-axis controller, for instance
     ...
     *
     * @return {YMultiAxisController | null} a pointer to a YMultiAxisController object, corresponding to
