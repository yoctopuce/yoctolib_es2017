/*********************************************************************
 *
 *  $Id: yocto_hubport.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YHubPort extends YFunction
{
     ...
     *
     * @return {Promise<number>} either YHubPort.ENABLED_FALSE or YHubPort.ENABLED_TRUE, according to true
     * if the YoctoHub port is powered, false otherwise
     *
     ...
     *
     * @return {Promise<number>} a value among YHubPort.PORTSTATE_OFF, YHubPort.PORTSTATE_OVRLD,
     ...
     *
     * @return {Promise<number>} an integer corresponding to the current baud rate used by this YoctoHub port, in kbps
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the YoctoHub slave port, for instance
     *         YHUBETH1.hubPort1.
     *
     ...
     *
     * @return {YHubPort | null} a pointer to a YHubPort object, corresponding to
