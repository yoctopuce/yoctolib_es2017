...
class YSpectralSensor extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the estimated color in RGB format
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the estimated color in HSL format
     *
