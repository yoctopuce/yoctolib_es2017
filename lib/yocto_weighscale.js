/*********************************************************************
 *
 * $Id: yocto_weighscale.js 29804 2018-01-30 18:05:21Z mvuilleu $
 *
...
class YWeighScale extends YSensor
{
    constructor(obj_yapi, str_func)
    {
        ...
        /** @member {number} **/
        this._compTempAdaptRatio         = YWeighScale.COMPTEMPADAPTRATIO_INVALID;
        /** @member {number} **/
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    async set_compTempAdaptRatio(newval)
    {
        /** @type {string} **/
        let rest_val;
        rest_val = String(Math.round(newval * 65536.0));
        return await this._setAttr('compTempAdaptRatio',rest_val);
    }
     ...
     * temperature. The standard rate is 0.04 percents, and the maximal rate is 65 percents.
     *
     * @return {number} a floating point number corresponding to the averaged temperature update rate, in percents
     *
     * On failure, throws an exception or returns YWeighScale.COMPTEMPADAPTRATIO_INVALID.
     */
    async get_compTempAdaptRatio()
    {
        /** @type {number} **/
        let res;
        if (this._cacheExpiration <= this._yapi.GetTickCount()) {
...
class YWeighScaleProxy extends YSensorProxy
{
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    set_compTempAdaptRatio(newval)
    {
        this.liveFunc.set_compTempAdaptRatio(newval);
        return this._yapi.SUCCESS;
    }
     ...
     */
    get_compTempAdaptRatio()
    {
        return this.liveFunc._compTempAdaptRatio;
    }
