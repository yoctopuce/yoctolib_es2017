...
class YWeighScale extends YSensor
{
     ...
     *
     * @return {Promise<number>} a value among YWeighScale.EXCITATION_OFF, YWeighScale.EXCITATION_DC and
     ...
     *
     * @param func {string} : a string that uniquely characterizes the weighing scale sensor, for instance
    ...
    async loadCompensationTable(tableIndex,tempValues,compValues)
    {
        ...
        idx = 0;
        while (idx < siz) {
            temp = this._yapi.imm_atof(this._yapi.imm_bin2str(paramlist[2*idx]))/1000.0;
            comp = this._yapi.imm_atof(this._yapi.imm_bin2str(paramlist[2*idx+1]))/1000.0;
     ...
     *
     * @return {YWeighScale | null} a pointer to a YWeighScale object, corresponding to
