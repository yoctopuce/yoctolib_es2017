/*********************************************************************
 *
 *  $Id: yocto_daisychain.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YDaisyChain extends YFunction
{
     ...
     *
     * @return {Promise<number>} a value among YDaisyChain.DAISYSTATE_READY,
     * YDaisyChain.DAISYSTATE_IS_CHILD, YDaisyChain.DAISYSTATE_FIRMWARE_MISMATCH,
     * YDaisyChain.DAISYSTATE_CHILD_MISSING and YDaisyChain.DAISYSTATE_CHILD_LOST corresponding to the
     * state of the daisy-link between modules
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of child nodes currently detected
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of child nodes expected in normal conditions
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the module chain, for instance
     *         MyDevice.daisyChain.
     *
     ...
     *
     * @return {YDaisyChain | null} a pointer to a YDaisyChain object, corresponding to
