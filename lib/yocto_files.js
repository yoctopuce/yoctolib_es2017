/*********************************************************************
 *
 * $Id: yocto_files.js 43580 2021-01-26 17:46:01Z mvuilleu $
 *
...
class YFileRecord
{
     ...
     *
     * @return {Promise<string>} a string with the name of the file.
     */
    async get_name()
    {
        return this._name;
     ...
     *
     * @return {Promise<number>} the size of the file.
     */
    async get_size()
    {
        return this._size;
     ...
     *
     * @return {Promise<number>} the 32-bit CRC of the file content.
     */
    async get_crc()
    {
        return this._crc;
...
class YFiles extends YFunction
{
     ...
     *
     * @return {Promise<boolean>} a true if the file exist, false otherwise.
     *
