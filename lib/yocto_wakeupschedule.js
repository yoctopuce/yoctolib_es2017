/*********************************************************************
 *
 *  $Id: yocto_wakeupschedule.js 63507 2024-11-28 10:44:36Z seb $
 *
...
class YWakeUpSchedule extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to the minutes in the 00-29 interval of each
     * hour scheduled for wake up
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the minutes in the 30-59 interval of each
     * hour scheduled for wake up
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the hours scheduled for wake up
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the days of the week scheduled for wake up
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the days of the month scheduled for wake up
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the months scheduled for wake up
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the number of seconds to anticipate wake-up time to allow
     *         the system to power-up
     *
     ...
     * modification must be kept.
     *
     * @param newval {number} : an integer corresponding to the number of seconds to anticipate wake-up time to allow
     *         the system to power-up
     *
     * @return {Promise<number>} YAPI.SUCCESS if the call succeeds.
     *
     ...
     *
     * @return {Promise<number>} an integer corresponding to the date/time (seconds) of the next wake up occurrence
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the wake up schedule, for instance
     ...
     *
     * @return {YWakeUpSchedule | null} a pointer to a YWakeUpSchedule object, corresponding to
...
class YWakeUpScheduleProxy extends YFunctionProxy
{
    ...
    get_secondsBefore()
    {
        return this.liveFunc._secondsBefore;
    }
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    set_secondsBefore(newval)
    {
        this.liveFunc.set_secondsBefore(newval);
        return this._yapi.SUCCESS;
    }
