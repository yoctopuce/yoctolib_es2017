...
class YGps extends YFunction
{
     ...
     * positioning data.
     *
     * @return {number} a value among YGps.CONSTELLATION_GPS, YGps.CONSTELLATION_GLONASS,
     ...
     *
     * @param newval {number} : a value among YGps.CONSTELLATION_GPS, YGps.CONSTELLATION_GLONASS,
     * YGps.CONSTELLATION_GALLILEO, YGps.CONSTELLATION_GNSS, YGps.CONSTELLATION_GPS_GLONASS,
     ...
     *
     * @param func {string} : a string that uniquely characterizes the GPS, for instance
     *         YGNSSMK1.gps.
     *
