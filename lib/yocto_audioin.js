/*********************************************************************
 *
 *  $Id: yocto_audioin.js 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YAudioIn extends YFunction
{
     ...
     *
     * @return {Promise<number>} an integer corresponding to audio input gain, in per cents
     *
     ...
     *
     * @return {Promise<number>} either YAudioIn.MUTE_FALSE or YAudioIn.MUTE_TRUE, according to the state
     ...
     *
     * @return {Promise<number>} an integer corresponding to the detected input signal level
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the audio input, for instance
     *         MyDevice.audioIn1.
     *
     ...
     *
     * @return {YAudioIn | null} a pointer to a YAudioIn object, corresponding to
