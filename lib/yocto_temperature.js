/*********************************************************************
 *
 *  $Id: yocto_temperature.js 33712 2018-12-14 14:19:38Z seb $
 *
...
class YTemperature extends YSensor
{
     ...
     * YTemperature.SENSORTYPE_RES_LINEAR, YTemperature.SENSORTYPE_RES_INTERNAL and
     * YTemperature.SENSORTYPE_IR corresponding to the temperature sensor type
     *
     * @return {number} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
