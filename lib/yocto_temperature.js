/*********************************************************************
 *
 * $Id: yocto_temperature.js 28142 2017-07-25 20:24:23Z mvuilleu $
 *
...
class YTemperature extends YSensor
{
    ...
    async get_syncProxy()
    {
        ...
        let res = new YTemperatureProxy(this);
     ...
     * YTemperature.SENSORTYPE_RES_LINEAR and YTemperature.SENSORTYPE_RES_INTERNAL
     *
     * @return {number} YAPI.SUCCESS if the call succeeds.
     *
     * On failure, throws an exception or returns a negative error code.
