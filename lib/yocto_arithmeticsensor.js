/*********************************************************************
 *
 *  $Id: yocto_arithmeticsensor.js 56077 2023-08-15 14:07:05Z mvuilleu $
 *
...
class YArithmeticSensor extends YSensor
{
     ...
     *
     * @return {Promise<string>} a string corresponding to a short informative description of the formula
     *
     ...
     *
     * @param func {string} : a string that uniquely characterizes the arithmetic sensor, for instance
     ...
     *
     * @return {Promise<number>} the current expression value if the call succeeds.
     *
     ...
     *
     * @return {Promise<string>} a string containing the mathematical expression.
     *
     * On failure, throws an exception or returns a negative error code.
     */
     ...
     *
     * @return {YArithmeticSensor | null} a pointer to a YArithmeticSensor object, corresponding to
