/*********************************************************************
 *
 * $Id: yocto_display.js 42088 2020-10-16 17:49:46Z mvuilleu $
 *
...
^export class YDisplayLayer
{
     ...
     *
     * @param mode {boolean} : true to enable anti-aliasing, false to
     *         disable it.
     *
     * @return {number} YAPI.SUCCESS if the call succeeds.
     *
...
^export class YDisplayProxy extends YFunctionProxy
{
