...
import { YAPI, YErrorMsg, YFunction, YFunctionProxy, YModule, YModuleProxy, YSensor, YSensorProxy, YDataLogger } from './yocto_api.mjs';
...
^export class YI2cPort extends YFunction
{
     ...
     *
     * @return {number} an integer corresponding to the maximum number of tasks in a job that the device can handle
     *
     ...
     *
     * @return {number} an integer corresponding to maximum size allowed for job files
     *
     ...
     *
     * @return {number} a value among YI2cPort.I2CVOLTAGELEVEL_OFF, YI2cPort.I2CVOLTAGELEVEL_3V3 and
     ...
     *
     * @return {Uint8Array} a list of bytes with the data received from slave device.
     *
...
^export class YI2cPortProxy extends YFunctionProxy
{
